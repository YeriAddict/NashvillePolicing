...
With the fact that there are over three million rows in mind, we decide to subset our data to a more manageable size. Since the years 2012-2016 have the cleanest data in general, we decided to subset these years for our research going forward. Our subsetted data has 1924464 rows.
